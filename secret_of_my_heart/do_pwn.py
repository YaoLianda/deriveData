...
mz=Maze(binary_path='./secret_of_my_heart',
	      s2e_project_path='/home/s2e/s2e/projects/secret',
...
#            poc_heapop.append(h)
#fp.close()
vulid_dict.append(16)
max_enum_size.append(0x130)
#limit_list.append(2)
...
mdata1 = measure_data(2, 15, 1501)
mdata2 = measure_data(4, 14, 1426)
flag, heapop, trace_name, ret_mdata = dig_and_fill_equation(layoutman, poc_heapop, poc_trace_name, [mdata1, mdata2])
ex_init.stop_core()
